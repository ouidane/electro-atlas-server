...
declare function createNewOrder(session: any, paymentId: unknown): Promise<{
    ...
    toJSON: {
        (options?: import("mongoose").ToObjectOptions & {
            flattenMaps?: true;
        }): import("mongoose").FlattenMaps<import("../models/orderModel").OrderDoc & Required<{
            _id: unknown;
        }>>;
        (options: import("mongoose").ToObjectOptions & {
            flattenMaps: false;
        }): import("../models/orderModel").OrderDoc & Required<{
            _id: unknown;
        }>;
    ...
    toObject: {
        (options?: import("mongoose").ToObjectOptions): import("../models/orderModel").OrderDoc & Required<{
            _id: unknown;
        }>;
